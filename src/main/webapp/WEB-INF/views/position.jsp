...
<div class="content">
    ...
    <div id="error-message"><%= request.getAttribute("positionError") %></div>
    <% } %>
    <h1>岗位管理</h1>
        ...
        <table>
            ...
            <c:forEach var="position" items="${positionList}" varStatus="bianhao">
                <tr>
                    ...
                    <td><fmt:formatDate value="${position.createTime}" pattern="yyyy年MM月dd日"/></td>
                    <td>
